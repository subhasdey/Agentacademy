      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
        <div>
          ...
          <p className="text-gray-500 text-[15px] leading-[1.8] mb-8" style={{ fontFamily: 'Inter, sans-serif' }}>
            Enrolling in the Complete Cohort — 12 weeks of live instruction, mentorship, and your co-certified Anthropic credential.
          </p>
        ...
        <div className="bg-white border border-gray-200 p-8 md:p-12">
          ...
          <button className="btn-black w-full justify-center mt-2 h-[52px]" style={{ display:'flex' }}>
            <Lock size={14}/> Pay $49 — Enroll Now
          </button>
